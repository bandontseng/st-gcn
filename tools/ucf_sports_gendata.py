...
from st_gcn.feeder.feeder_ucf_sports import Feeder_ucf_sports
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='UCF Sports Data Converter.')
    parser.add_argument(
        '--data_path', default='data/ucf_sports/poses')
    parser.add_argument(
        '--out_folder', default='data/ucf_sports/poses')
    arg = parser.parse_args()

    part = ['train', 'val']
    for p in part:
        data_path = '{}/st-gcn_format'.format(arg.data_path)
        label_path = '{}/fake_labels.json'.format(arg.data_path)
