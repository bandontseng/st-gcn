...
class Feeder_ucf_sports(torch.utils.data.Dataset):
    ...
    def load_data(self):
        ...
        sample_id = [name[0:-5] for name in self.sample_name]
        self.label = np.array(
...
def test(data_path, label_path, vid=None, graph=None):
    ...
    if vid is None:
        ...
        sample_id = [name[0:-5] for name in sample_name]
        print(sample_id)
...
if __name__ == '__main__':
    data_path = './data/ucf_sports/poses/st-gcn_format'
